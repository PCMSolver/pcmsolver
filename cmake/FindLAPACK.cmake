...
if (NOT LAPACK_FIND_COMPONENTS)
    ...
    elseif(ENABLE_64BIT_INTEGERS)
        ...
        set(LAPACK_FIND_COMPONENTS MKL ESSL Atlas ACML default)
    endif()
endif()
...
macro(find_essl)
    find_math_libs(lapack essl)
    cache_math_result(lapack ESSL)
endmacro()
...
macro(find_atlas)
    ...
    find_math_libs(lapack atlas lapack)
