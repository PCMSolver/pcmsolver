...
macro(write_to_Includer headers_list)
	foreach(header ${headers_list})
        	file(APPEND ${CMAKE_BINARY_DIR}/include/Includer.hpp "#include \"${header}\"\n")
        endforeach()
endmacro()
...
macro(write_to_cloc_list list_of_sources)
	...
	foreach(source ${list_of_sources})
		file(APPEND ${CMAKE_BINARY_DIR}/cloc/cloc_list-${lib} "${CMAKE_SOURCE_DIR}/src/${lib}/${source}\n")
        endforeach()
endmacro()

# Generate the FCMangle header and post-process it to add the copyright notice
macro(init_FCMangle)
	FortranCInterface_HEADER(${CMAKE_BINARY_DIR}/include/FCMangle.hpp)
	file(STRINGS ${CMAKE_BINARY_DIR}/include/FCMangle.hpp contents NEWLINE_CONSUME)
        file(WRITE ${CMAKE_BINARY_DIR}/include/FCMangle.hpp
        		"/* pcmsolver_copyright_start */\n/* pcmsolver_copyright_end */\n\n")
        file(APPEND ${CMAKE_BINARY_DIR}/include/FCMangle.hpp "// Header file automagically generated by CMake. DO NOT TOUCH!\n")
        file(APPEND ${CMAKE_BINARY_DIR}/include/FCMangle.hpp ${contents})
endmacro()

# Generate the Includer header and post-process it to add the copyright notice
macro(init_Includer)
	# Initialize Includer.hpp header
	file(WRITE ${CMAKE_BINARY_DIR}/include/Includer.hpp
		"/* pcmsolver_copyright_start */\n/* pcmsolver_copyright_end */\n\n")
	file(APPEND ${CMAKE_BINARY_DIR}/include/Includer.hpp "// Header file automagically generated by CMake. DO NOT TOUCH!\n")
	execute_process(COMMAND ${PYTHON_EXECUTABLE} "${CMAKE_BINARY_DIR}/bin/update_copyright.py" 
...
macro(configure_files)
	...
	configure_file(${CMAKE_SOURCE_DIR}/tools/pcmsolver.py.in pcmsolver.py)
        file(COPY ${CMAKE_BINARY_DIR}/pcmsolver.py 
          DESTINATION ${CMAKE_BINARY_DIR}/bin
          FILE_PERMISSIONS OWNER_READ OWNER_WRITE OWNER_EXECUTE GROUP_READ
          GROUP_EXECUTE WORLD_READ WORLD_EXECUTE)
  	# Configure the touch_cmakelists utility script
        configure_file(${CMAKE_SOURCE_DIR}/tools/touch_cmakelists.py.in touch_cmakelists.py)
        file(COPY ${CMAKE_BINARY_DIR}/touch_cmakelists.py 
          DESTINATION ${CMAKE_BINARY_DIR}/bin
          FILE_PERMISSIONS OWNER_READ OWNER_WRITE OWNER_EXECUTE GROUP_READ
          GROUP_EXECUTE WORLD_READ WORLD_EXECUTE)
  	# Configure the update_gh-pages utility script
        configure_file(${CMAKE_SOURCE_DIR}/tools/update_gh-pages.py.in update_gh-pages.py)
        file(COPY ${CMAKE_BINARY_DIR}/update_gh-pages.py 
          DESTINATION ${CMAKE_BINARY_DIR}/bin
          FILE_PERMISSIONS OWNER_READ OWNER_WRITE OWNER_EXECUTE GROUP_READ
          GROUP_EXECUTE WORLD_READ WORLD_EXECUTE)
  	# Configure the counter utility script
        configure_file(${CMAKE_SOURCE_DIR}/tools/counter.py.in counter.py)
        file(COPY ${CMAKE_BINARY_DIR}/counter.py 
          DESTINATION ${CMAKE_BINARY_DIR}/bin
          FILE_PERMISSIONS OWNER_READ OWNER_WRITE OWNER_EXECUTE GROUP_READ
          GROUP_EXECUTE WORLD_READ WORLD_EXECUTE)
  	# Configure the extract_notice utility script
        configure_file(${CMAKE_SOURCE_DIR}/tools/extract_notice.py.in extract_notice.py)
        file(COPY ${CMAKE_BINARY_DIR}/extract_notice.py 
          DESTINATION ${CMAKE_BINARY_DIR}/bin
          FILE_PERMISSIONS OWNER_READ OWNER_WRITE OWNER_EXECUTE GROUP_READ
          GROUP_EXECUTE WORLD_READ WORLD_EXECUTE)
  	# Configure the update_copyright utility script
        configure_file(${CMAKE_SOURCE_DIR}/tools/update_copyright.py.in update_copyright.py)
        file(COPY ${CMAKE_BINARY_DIR}/update_copyright.py 
          DESTINATION ${CMAKE_BINARY_DIR}/bin
          FILE_PERMISSIONS OWNER_READ OWNER_WRITE OWNER_EXECUTE GROUP_READ
          GROUP_EXECUTE WORLD_READ WORLD_EXECUTE)
