...
if(CMAKE_Fortran_COMPILER_ID MATCHES GNU) # this is gfortran
	set(CMAKE_Fortran_FLAGS         "${CMAKE_Fortran_FLAGS} -DVAR_GFORTRAN -DGFORTRAN=445 -fPIC -fautomatic -std=f2003")
	set(CMAKE_Fortran_FLAGS_DEBUG   "${CMAKE_Fortran_FLAGS_DEBUG} -O0 -g -fbacktrace -Wall -fbounds-check")
    ...
    if(ENABLE_CODE_COVERAGE)
        set(CMAKE_Fortran_FLAGS "${CMAKE_Fortran_FLAGS} -ftest-coverage")
    endif()
endif()
...
if(CMAKE_Fortran_COMPILER_ID MATCHES Intel)
    ...
    set(CMAKE_Fortran_FLAGS_DEBUG   "${CMAKE_Fortran_FLAGS_DEBUG} -O0 -g -warn all -ftrapuv")
