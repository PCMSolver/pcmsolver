...
configure_file(${PROJECT_SOURCE_DIR}/tools/pcmsolver.py.in pcmsolver.py @ONLY)
...
configure_file(${PROJECT_SOURCE_DIR}/tools/touch_cmakelists.py.in touch_cmakelists.py @ONLY)
...
configure_file(${PROJECT_SOURCE_DIR}/tools/update_gh-pages.py.in update_gh-pages.py @ONLY)
...
configure_file(${PROJECT_SOURCE_DIR}/tools/counter.py.in counter.py @ONLY)
...
configure_file(${PROJECT_SOURCE_DIR}/tools/extract_notice.py.in extract_notice.py @ONLY)
...
configure_file(${PROJECT_SOURCE_DIR}/tools/update_copyright.py.in update_copyright.py @ONLY)
