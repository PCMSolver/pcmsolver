...
%% Group 1 - IA
  ...
  \node[name=Cs, below of=Rb, NoRadius]
  {\NaturalElementTextFormat{55}{0.0}{Cs}{Caesium}};
  \node[name=Fr, below of=Cs, NoRadius]
  {\NaturalElementTextFormat{87}{0.0}{Fr}{Francium}};
...
%% Group 2 - IIA
  ...
  \node[name=Ba, below of=Sr, NoRadius]
  {\NaturalElementTextFormat{56}{0.0}{Ba}{Barium}};
  \node[name=Ra, below of=Ba, NoRadius]
  {\NaturalElementTextFormat{88}{0.0}{Ra}{Radium}};
...
%% Group 10 - VIIIB
  ...
  \node[name=Pd, below of=Ni, NoRadius]
  {\NaturalElementTextFormat{46}{0.0}{Pd}{Palladium}};
  \node[name=Pt, below of=Pd, NoRadius]
  {\NaturalElementTextFormat{78}{0.0}{Pt}{Platinum}};
...
%% Group 11 - IB
  ...
  \node[name=Ag, below of=Cu, NoRadius]
  {\NaturalElementTextFormat{47}{0.0}{Ag}{Silver}};
  \node[name=Au, below of=Ag, NoRadius]
  {\NaturalElementTextFormat{79}{0.0}{Au}{Gold}};
...
%% Group 12 - IIB
  ...
  \node[name=Cd, below of=Zn, NoRadius]
  {\NaturalElementTextFormat{48}{0.0}{Cd}{Cadmium}};
  \node[name=Hg, below of=Cd, NoRadius]
  {\NaturalElementTextFormat{80}{0.0}{Hg}{Mercury}};
...
%% Group 13 - IIIA
  ...
  \node[name=In, below of=Ga, NoRadius]
  {\NaturalElementTextFormat{49}{0.0}{In}{Indium}};
  \node[name=Tl, below of=In, NoRadius]
  {\NaturalElementTextFormat{81}{0.0}{Tl}{Thallium}};
...
%% Group 14 - IVA
  ...
  \node[name=Sn, below of=Ge, NoRadius]
  {\NaturalElementTextFormat{50}{0.0}{Sn}{Tin}};
  \node[name=Pb, below of=Sn, NoRadius]
  {\NaturalElementTextFormat{82}{0.0}{Pb}{Lead}};
...
%% Group 15 - VA
  ...
  \node[name=Sb, below of=As, NoRadius]
  {\NaturalElementTextFormat{51}{0.0}{Sb}{Antimony}};
  \node[name=Bi, below of=Sb, NoRadius]
  {\NaturalElementTextFormat{83}{0.0}{Bi}{Bismuth}};
...
%% Group 16 - VIA
  ...
  \node[name=Te, below of=Se, NoRadius]
  {\NaturalElementTextFormat{52}{0.0}{Te}{Tellurium}};
  \node[name=Po, below of=Te, NoRadius]
  {\NaturalElementTextFormat{84}{0.0}{Po}{Polonium}};
...
%% Group 17 - VIIA
  ...
  \node[name=At, below of=I, NoRadius]
  {\NaturalElementTextFormat{85}{0.0}{At}{Astatine}};
...
%% Group 18 - VIIIA
  ...
  \node[name=Xe, below of=Kr, NoRadius]
  {\NaturalElementTextFormat{54}{0.0}{Xe}{Xenon}};
  \node[name=Rn, below of=Xe, NoRadius]
  {\NaturalElementTextFormat{86}{0.0}{Rn}{Radon}};
