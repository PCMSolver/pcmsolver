...
public:
    ...
    virtual double computeS(const TanhSphericalDiffuse * gf, const Element & e) const = 0;

    virtual double computeD(const TanhSphericalDiffuse * gf, const Element & e) const = 0;
};
