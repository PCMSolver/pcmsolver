...
double PurisimaIntegrator::computeS(const TanhSphericalDiffuse * /* gf */, const Element & /* e */) const {
    // The singular part is "integrated" as usual, while the nonsingular part is evaluated in full
	return 0.0;
}

double PurisimaIntegrator::computeD(const TanhSphericalDiffuse * /* gf */, const Element & /* e */) const {
    // The singular part is "integrated" as usual, while the nonsingular part is evaluated in full
	return 0.0;
}
