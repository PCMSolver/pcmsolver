...
public:
    ...
    Eigen::Array4d evaluate(Eigen::Vector3d & sourceNormal_, Eigen::Vector3d & source_,
     ...
     */
    void compOffDiagonal(const Eigen::Matrix3Xd & elementCenter_,
                         const Eigen::Matrix3Xd & elementNormal_,
