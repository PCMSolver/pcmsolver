...
void MetalSphere::compDiagonal(const Eigen::VectorXd & elementArea_,
...
Eigen::Array4d MetalSphere::numericalDirectional(Eigen::Vector3d & sourceNormal_,
        ...
        Eigen::Vector3d & probeNormal_, Eigen::Vector3d & probe_) const
{
    ...
    epsre = epsMetal.real();
    epsim = epsMetal.imag();
    gsfera_cpp_(&epsSolvent, &epsre, &epsim, &sphRadius, sphere, point1, point2,
                &greenre, &greenim);
...
Eigen::Array4d MetalSphere::analyticDirectional(Eigen::Vector3d & sourceNormal_,
        Eigen::Vector3d & source_,
        Eigen::Vector3d & probeNormal_, Eigen::Vector3d & probe_) const
{
...
Eigen::Array4d MetalSphere::automaticDirectional(Eigen::Vector3d & sourceNormal_,
        Eigen::Vector3d & source_,
        Eigen::Vector3d & probeNormal_, Eigen::Vector3d & probe_) const
{
...
Eigen::Array4d MetalSphere::automaticGradient(Eigen::Vector3d & sourceNormal_,
        Eigen::Vector3d & source_,
        Eigen::Vector3d & probeNormal_, Eigen::Vector3d & probe_) const
{
...
Eigen::Array4d MetalSphere::automaticHessian(Eigen::Vector3d & sourceNormal_,
        Eigen::Vector3d & source_,
        Eigen::Vector3d & probeNormal_, Eigen::Vector3d & probe_) const
{
