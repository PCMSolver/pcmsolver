...
double NumericalIntegrator::computeS(const TanhSphericalDiffuse * /* gf */, double /* area */) const {
	return 0.0;
}

double NumericalIntegrator::computeD(const TanhSphericalDiffuse * /* gf */, double /* area */, double /* radius */) const {
	return 0.0;
}
