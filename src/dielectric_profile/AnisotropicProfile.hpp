...
#ifndef ANISOTROPICPROFILE_HPP
#define ANISOTROPICPROFILE_HPP
...
public:
     ...
     */
    AnisotropicProfile(const Eigen::Vector3d & eigen_eps, const Eigen::Vector3d & euler_ang) : 
