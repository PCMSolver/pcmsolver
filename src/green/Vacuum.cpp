...
KernelS Vacuum<DerivativeTraits>::exportKernelS_impl() const {
  return std::bind(&Vacuum<DerivativeTraits>::kernelS, *this, std::placeholders::_1, std::placeholders::_2);
}

template <typename DerivativeTraits>
KernelD Vacuum<DerivativeTraits>::exportKernelD_impl() const {
  return std::bind(
      &Vacuum<DerivativeTraits>::kernelD, *this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
}

template <typename DerivativeTraits>
DerivativeProbe Vacuum<DerivativeTraits>::exportDerivativeProbe_impl() const {
  return std::bind(
      &Vacuum<DerivativeTraits>::derivativeProbe, *this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
}
