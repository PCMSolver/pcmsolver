...
//            Atom("Name",    "Symbol", Charge,     Mass,   Radius, Center, Scaling)
  ...
  UFF[ 92] = Atom("Neptunium",     "Np",   93.0, 237.0000000, 1.7120, Origin, 1.2);
  UFF[ 93] = Atom("Plutonium",     "Pu",   94.0, 244.0000000, 1.7120, Origin, 1.2);
  UFF[ 94] = Atom("Americium",     "Am",   95.0, 243.0000000, 1.6905, Origin, 1.2);
  UFF[ 95] = Atom("Curium",        "Cm",   96.0, 247.0000000, 1.6630, Origin, 1.2);
  UFF[ 96] = Atom("Berkelium",     "Bk",   97.0, 247.0000000, 1.6695, Origin, 1.2);
  UFF[ 97] = Atom("Californium",   "Cf",   98.0, 251.0000000, 1.6565, Origin, 1.2);
  UFF[ 98] = Atom("Einsteinium",   "Es",   99.0, 252.0000000, 1.6495, Origin, 1.2);
  UFF[ 99] = Atom("Fermium",       "Fm",  100.0, 257.0000000, 1.6430, Origin, 1.2);
  UFF[100] = Atom("Mendelevium",   "Md",  101.0, 258.0000000, 1.6370, Origin, 1.2);
  UFF[101] = Atom("Nobelium",      "No",  102.0, 259.0000000, 1.6240, Origin, 1.2);
  UFF[102] = Atom("Lawrencium",    "Lr",  103.0, 266.0000000, 1.6180, Origin, 1.2);
...
//                  Atom("Name",    "Symbol", Charge,     Mass,   Radius, Center, Scaling)
  ...
  Allinger[ 63] = Atom("Gadolinium",    "Gd",   64.0, 157.9240190, 2.71/1.2, Origin, 1.0);
  Allinger[ 64] = Atom("Terbium",       "Tb",   65.0, 158.9253420, 2.70/1.2, Origin, 1.0);
  Allinger[ 65] = Atom("Dysprosium",    "Dy",   66.0, 163.9291710, 2.69/1.2, Origin, 1.0);
  ...
  Allinger[ 90] = Atom("Protactinium",  "Pa",   91.0, 231.0358800, 2.64/1.2, Origin, 1.0);
  ...
  Allinger[100] = Atom("Mendelevium",   "Md",  101.0, 258.0000000, 0.000000, Origin, 1.0);
  Allinger[101] = Atom("Nobelium",      "No",  102.0, 259.0000000, 0.000000, Origin, 1.0);
  Allinger[102] = Atom("Lawrencium",    "Lr",  103.0, 266.0000000, 0.000000, Origin, 1.0);
  Allinger[103] = Atom("Rutherfordium", "Rf",  104.0, 267.0000000, 2.73/1.2, Origin, 1.0);
  Allinger[104] = Atom("Dubnium",       "Db",  105.0, 268.0000000, 2.63/1.2, Origin, 1.0);
  Allinger[105] = Atom("Seaborgium",    "Sg",  106.0, 229.0000000, 0.000000, Origin, 1.0);
  ...
  Allinger[108] = Atom("Meitnerium",    "Mt",  109.0, 278.0000000, 0.000000, Origin, 1.0);
  Allinger[109] = Atom("Darmstadtium",  "Ds",  110.0, 281.0000000, 0.000000, Origin, 1.0);
  Allinger[110] = Atom("Roentgenium",   "Rg",  111.0, 282.0000000, 0.000000, Origin, 1.0);
  Allinger[111] = Atom("Copernicium",   "Cn",  112.0, 285.0000000, 0.000000, Origin, 1.0);
  Allinger[112] = Atom("Ununtrium",     "Uut", 113.0, 286.0000000, 0.000000, Origin, 1.0);
  Allinger[113] = Atom("Flerovium",     "Fl",  114.0, 289.0000000, 0.000000, Origin, 1.0);
  Allinger[114] = Atom("Ununpentium",   "Uup", 115.0, 289.0000000, 0.000000, Origin, 1.0);
  Allinger[115] = Atom("Livermorium",   "Lv",  116.0, 293.0000000, 0.000000, Origin, 1.0);
  Allinger[116] = Atom("Ununseptium",   "Uus", 117.0, 294.0000000, 0.000000, Origin, 1.0);
  Allinger[117] = Atom("Ununoctium",    "Uuo", 118.0, 294.0000000, 0.000000, Origin, 1.0);
// ------------------------------------------------------------
