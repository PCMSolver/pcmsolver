...
void hojr_four_coqd(int, int, manif_tl, manif_tl, rgb_lk *, sphere *, int, int, int, int *);
...
int hubs_smoo_citg(prat_main, manif_tl, int, int, int *, int, int, point *, int *, int *, int);
