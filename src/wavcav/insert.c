...
void fikg_inse_cenp(manif_ro * M, parm P, int s, int ni, int nj)
{
    ...
    M->kt[ned].frent = s;
    M->kt[ned].scent = nel;
    M->kt[ned + 1].frvrt = nnd;
    M->kt[ned + 1].scvrt = ni;
    M->kt[ned + 1].frent = nel;
    M->kt[ned + 1].scent = nel + 1;
    M->kt[ned + 2].frvrt = nnd;
    M->kt[ned + 2].scvrt = nl;
    M->kt[ned + 2].frent = t;
    M->kt[ned + 2].scent = nel + 1;
    M->k_grs = ned + 3;
...
void lask_inse_gifk(manif_ro * M, parm P, int s)
{
    ...
    M->kt[ned].scent = nel;
    M->kt[ned + 1].frvrt = nj;
    M->kt[ned + 1].scvrt = nnd;
    M->kt[ned + 1].frent = s;
    M->kt[ned + 1].scent = nel + 1;
    M->kt[ned + 2].frvrt = nk;
    M->kt[ned + 2].scvrt = nnd;
    M->kt[ned + 2].frent = nel;
    M->kt[ned + 2].scent = nel + 1;
    M->k_grs = ned + 3;
...
void multiple_refinement(manif_ro mshin, int max, double anisotropy, double accuracy, manif_ro * mshout)
{
    int i, nel, nnd, ned;
