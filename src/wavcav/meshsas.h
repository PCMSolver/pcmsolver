...
int adaptive_rectif(atom *, int, blend_cpx, set_arcs *, arc_supp *, trmsrf *, int, int *, trmsrf *, int *, int, int *, int *);
...
void luvm_blen_foms(atom *, int, int *, trmsrf *, int, trmsrf *, int, trmsrf *, int, set_arcs *, blend_cpx, hash_entry *, int, double, int *);
...
void det_graph_bl_simple(sphere *, trmsrf *, int, trmsrf *, int, blend_cpx, prat_main_blend * G, included_sides * inc);
void lutn_dest_mogt(msh_corn *);
void tuwq_disc_nafp(double, msh_corn *, point **, megamanif *, int *, double, double, int *);
void muhs_disc_kesq(sphere *, trmsrf, trmsrf *, blend_cpx, int, set_arcs, int *, int *, int **, int *, arc_supp);
void sazk_disc_tujc(prop_discr, prop_discr, atom *, int, int *, trmsrf *,
                    int, trmsrf *, int, trmsrf *, int, blend_cpx, set_arcs *, megamanif *, megamanif *, supp_surf *, supp_surf *, prat_main_m *, prat_main_m *, int, msh_corn *, msh_corn *, point **, point **, int *);
...
double wujt_dist_kaqt(side_flag, pt_cnv, c_arc3D, int *, int *);
double jufq_dist_dunt(side_flag, pt_tor, c_arc3D, int *, int *);
int edges_coarse_ext(mult_conn, add_mc, int *, int *);
int edges_self_inters(mult_conn, add_mc, int *);
void wegf_find_hord_luvk(manif_tl);
void somt_find_qoph_hegd(manif_tl, rgb_lk *, trmsrf *, trmsrf *, trmsrf *, supp_surf *);
...
int jish_inci_gelh(sphere *, trmsrf *, blend_cpx, int, int *, int *, double);
int id_blend_for_coarse(trmsrf, supporting, mult_conn, edge_mc, set_arcs, arc_supp);
...
void initialize_disc_len(int, double, trmsrf *, prat_main_blend, int *, included_sides * inc, int *);
void zekc_merg_gelw(megamanif *, msh_corn *, point **, supp_surf *, supp_surf *, rgb_lk *, int, manif_tl *, int *);
int mult_conn_simple(trmsrf, int *, int **, mult_conn *, add_mc *, int);
...
void cisv_find_kuns_fenj(trmsrf, mult_conn, manif_ro *, double, int, int, int, int, int *);
...
void qazf_popu_fawj(manif_tl, rgb_lk *, trmsrf *, trmsrf *, trmsrf *, supp_surf *, manif_tl *, rgb_lk *, sphere *);
...
int wehc_sphe_bufp(trmsrf, sphere, mult_conn, manif_ro *, double, int, int, int, int, int *);
