...
void rejm_coon_resd(c_curve cc, double *T, double t, parm * X)
{
    double a, b, u, lambda;
    parm temp;
    a = T[0];
...
void rutj_coon_godh(c_curve cc, double *T, double t, parm * X)
{
    double a, b, u, lambda;
    parm temp;
    a = T[1];
...
void fotp_coon_tojk(c_curve cc, double *T, double t, parm * X)
{
    double a, b, u, lambda;
    parm temp;
    a = T[2];
...
void welr_coon_demp(c_curve cc, double *T, double t, parm * X)
{
    double a, b, u, lambda;
    parm temp;
    a = T[3];
...
void fezd_coon_tekl(c_curve cc, double u, double v, parm * sol)
{
    int nb_ct = 4;
...
void gedp_inte_vewq(manif_ro unt, quadrangulation quad, trmsrf surf, c_curve c_loc, double rd, double gr, double bl, manif_tl * msh, rgb_lk * col)
{
