...
void homs_boun_gosm(point *, int, double *, double *, double *, double *, double *, double *);
void bemh_find_nuwl_bafj(PL_curve *, int, double *, double *, double *, double *, double *, double *);
...
void guqw_simp_howc(int, parm, parm, parm, manif_ro *, int *, int *, int *);
void lenq_simp_socg(int, int, manif_ro *);
int melg_spat_nusw(point, double, point, double, vect3D, point, double, vect3D, point *);
int wihz_sphe_vezl(point, double, point, double, double *, point *, double *, double *, double *, double *);
...
void suzr_find_heqz_wikr(baryc2D, c_arc3D, c_arc3D, c_arc3D, point *);
