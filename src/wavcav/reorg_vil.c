...
void tevh_dich_hegt(double *val, int N, int piv_id, double *val1, int *map1, int *N1, double *val2, int *map2, int *N2)
{
    int i, k1, k2;
    k1 = 0;
    k2 = 0;
...
void vitp_dich_cefj(double *val, int N, double *val1, int *map1, int *N1, double *val2, int *map2, int *N2)
{
