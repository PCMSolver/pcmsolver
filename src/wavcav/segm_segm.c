...
int kesn_segm_lafn(parm P1, parm P2, parm P3, parm P4, double marg, double eps, double mu)
{
...
int hezp_segm_gods(parm P1, parm P2, parm P3, parm P4, double marg, double eps, double mu, parm * T)
{
    int ts_par, res, bx, ts;
    double s, t;
    bx = murt_find_wulp_serk(P1, P2, P3, P4, marg);
...
int ruhp_segm_zisk(parm P1, parm P2, parm P3, parm P4, double marg, double eps, double mu)
{
    int ts_par, res, bx, ts;
    double s, t;
    bx = murt_find_wulp_serk(P1, P2, P3, P4, marg);
