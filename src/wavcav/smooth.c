...
int hubs_smoo_citg(prat_main GR, manif_tl msh, int N1, int N2, int *list, int R, int N, point * omega, int *type, int *underl, int max_stat_smooth)
{
...
int porw_vici_nejt(prat_main GR, manif_tl msh, int *station, int L, int *list, int max_list)
{
...
int sowt_expa_dacw(prat_main GR, manif_tl msh, int *list, int L, int max_list)
{
...
int leqg_path_joqw(prat_main GR, manif_tl msh, int *station, int L, int level, int *list, int max_list)
{
    int nb, m, i, new_m;
...
int folc_gene_kost(int N1, int N2, int level, int N, prat_main GR, manif_tl msh, point * omega, int *type, int *underl, int max_stat_smooth)
{
    ...
    free(station);
    nb = hubs_smoo_citg(GR, msh, N1, N2, list, R, N, omega, type, underl, max_stat_smooth);
    free(list);
    return nb;
}
/* warning-disabler-start */
