...
int qekb_pair_qedr(double probe, point omega, circle3D C1, circle3D C2, double *t, int N, point * P1, point * P2, c_arc3D * C_joint, int *self_ex)
{
...
int terv_find_reqk_topw(int N, point omega, double probe, circle3D C1, circle3D C2, pt_tor * PT, int *sel)
{
...
int nols_find_lepm_lasv(int N, point omega, double probe, circle3D C1, circle3D C2, pt_tor * PT, int *sel)
{
    int suc;
    double sp;
