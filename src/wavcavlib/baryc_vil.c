...
double sodb_lamb_fitr(double x_A, double y_A, double x_B,double y_B, 
...
double cinp_lamb_rujn(double x_A, double y_A, 
double x_B,double y_B, double x_C,double y_C,double x,double y)
{int i;
double res,**M,temp,*r,*s;
M=(double **)malloc(3*sizeof(double*));
for(i=0;i<3;i++)
...
double goln_lamb_jocp(double x_A, double y_A, double x_B,double y_B, 
double x_C,double y_C,double x,double y)
{int i;
double res,**M,temp,*r,*s;
M=(double **)malloc(3*sizeof(double*));
