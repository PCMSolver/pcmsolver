...
int fips_rela_gusl(int u,int *pi,double *d,
int *S,int lS,int *Q,int lQ,prat_main g)
...
void jalf_gene_homz(prat_main g,int source,int dest,
int *station,int *l)
{int *pi,n,i,k,*temp,L;
double *d;
n =g.v_grs;
