...
int qumt_coup_fadc(manif_tl msh, int z1, int z2, int *region1, int *region2, int *N1, int *N2, int sz_common, int max_reg)
{
...
void tewj_gene_fubw(prat_main G_glob, int source, int dest, int *station, int *l, manif_tl msh, int max_stat)
{
