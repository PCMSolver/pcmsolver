...
int fihn_find_relj_kesw(manif_ro unt,bd_box2D *B,manif_tl img,
sphere *S_img,parm p,point *P)
...
for(i=0;i<nel;i++)
	...
	ts=tewz_test_sowh(unt.knot[n1],unt.knot[n2],unt.knot[n3],
	B[i].x_min,B[i].x_max,B[i].y_min,B[i].y_max,p);
	if(ts==1)
		{q=i;
		break;
		}
...
if(suc==SUCCESS)
	...
	lm1=vupq_lamb_qofc(unt.knot[n1].u,unt.knot[n1].v,unt.knot[n2].u,unt.knot[n2].v,
	unt.knot[n3].u,unt.knot[n3].v,p.u,p.v);
	lm2=dopg_lamb_nupd(unt.knot[n1].u,unt.knot[n1].v,unt.knot[n2].u,unt.knot[n2].v,
	unt.knot[n3].u,unt.knot[n3].v,p.u,p.v);
	lm3=mofr_lamb_powg(unt.knot[n1].u,unt.knot[n1].v,unt.knot[n2].u,unt.knot[n2].v,
	unt.knot[n3].u,unt.knot[n3].v,p.u,p.v);
...
int dagt_find_tunv_letr(manif_ro unt,bd_box2D *B,manif_tl img,sphere *S_img,
int L,int M,double *u,double *v,point **P)
...
void jomh_choo_gafc(point str,point trm,int *exc,
ns_curv *CRV,ns_curv *C)
{int i,ort,q,q_ort;
double sml,dis;
sml=LARGE_NUMBER;
...
void pitj_orga_lesg(ns_curv *CRV,point **P,int L,int M,
ns_curv *C_1,ns_curv *C_2,ns_curv *C_3,ns_curv *C_4)
{int *exc,i;
...
int gapw_smoo_pogh(double **mat_lf,double **mat_rg,int n,manif_ro unt,
manif_tl img,sphere *S_img,ns_curv *CRV,ns_surf *S)
...
int picn_find_vezj_pazq(double **mat_lf,double **mat_rg,int n,
int *cv,ns_curv *B,manif_tl *img,sphere *S_img,point *coin,
int *zoro,ns_surf *S)
