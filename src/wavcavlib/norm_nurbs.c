...
void destroy_nurbs_surface_alx(prop_n_surf pns, ns_surf * ns)
{
    int i, nnu, nnv, kku, kkv;
    nnu = pns.nu;
    nnv = pns.nv;
...
double vulj_surf_mukl(int ku, int kv, int nu, int nv, double **d, double *tau_u, double *tau_v, double u, double v, int r_u, int r_v)
{
    int i, j;
...
void golj_surf_lonr(int ku, int kv, int nu, int nv, point ** d, double *tau_u, double *tau_v, double u, double v, point * sol)
{
    int i, j, r_u, r_v;
...
double lohk_surf_gahk(int ku, int kv, int nu, int nv, double **d, double *tau_u, double *tau_v, double u, double v)
{
    int r_u, r_v;
    double sol;
...
void decr_find_fiht_pefl(int ku, int kv, int nu, int nv, point ** d, double **w, double *tau_u, double *tau_v, double u, double v, point * sol)
{
    int i, j;
    double den;
    point **D, num;
