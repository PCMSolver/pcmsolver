...
void torq_quad_sofn(quadrangulation QUAD,int na,
int nb,line_entity *L)
...
void wegq_rest_wunr(circle3D cir,trmsrf surf,
int n1,int n2,int i,int comp,quadrangulation QUAD,
c_curve *C)
{int r,nb_ct,w;
...
int wofs_edge_pavc(int e,trmsrf surf,
quadrangulation QUAD,int n1,int n2,int *idx)
{int cp=-1,fl1,fl2;
fl1=QUAD.flag[n1];
fl2=QUAD.flag[n2];
...
void gojw_quad_wuln(int hemi,trmsrf surf,
quadrangulation quad,int s,c_curve *C)
