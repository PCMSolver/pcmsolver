...
void tuhl_subm_gups(manif_ro msh,int *clos,int nb,manif_ro *sub,
int *map_nd,int *map_el)
...
int nogl_orde_rasz(manif_ro msh,int *E,
int N,int *nd,int *forc_term)
...
int kecf_list_haqr(manif_ro msh,int z,hash_entry *H,
int *seq,int *forc_term)
