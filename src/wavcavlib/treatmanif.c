...
void degr_find_fuqd(manif_tl msh,double *XMIN,double *XMAX,
...
void goft_find_doqk(manif_tl msh,double *XMIN,double *XMAX,
double *YMIN,double *YMAX,double *ZMIN,double *ZMAX)
...
void nahd_find_vukd_gaph(manif_tl *msh,double xmin,double xmax,
 double ymin,double ymax,double zmin,double zmax)
...
int vist_find_jetl(manif_tl msh,int el,
