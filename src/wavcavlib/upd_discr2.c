...
void disc_parm_supporting(sphere *S,trmsrf ts,
...
void gen_loc_mult_conn(atom *S,int nb_sph,blend_cpx BC,set_arcs *SA,
trmsrf *surf1,int q,trmsrf *surf2,
int *supp,int *n_len,arc_supp *A,mult_conn *P,add_mc *P_app,
supporting *sp,int max_nvt)
...
disc_parm_supporting(S,surf1[q],surf2,BC,z,SA[z],n_len,
dis_ex,dis_in,endp,A[z],sp);
free(endp);
...
int edges_interference(mult_conn mc,add_mc AM,
int *list,int *forc_term)
