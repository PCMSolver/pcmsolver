...
int fucm_disc_saqh(double scl,double scl2,manif_tl *msh,
int max_ned,int *map_el)
...
nel_old=msh->e_grs;
ned=msh->k_grs;
if(ned<max_col_aux)	max_col=ned;
else				max_col=max_col_aux;
...
void nusp_disc_jidk(double scl,double scl2,manif_tl *msh,
rgb_lk *col,sphere *S,int max_ned)
