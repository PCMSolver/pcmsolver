...
unsigned int 
wavelet_wavelet_criterion(bounding_box_gamma *B1, bounding_box_square *B2,
...
void 
compute_bounding_boxes_gamma(B, W, E, p, M)
...
void 
compute_bounding_boxes_square(B, W, E, p, M)
...
unsigned int 
wavelet_wavelet_criterion(B1, B2, W, E, ind1, ind2, c1, c2)
