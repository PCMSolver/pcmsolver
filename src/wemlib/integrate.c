...
if (E[ind1].level == E[ind2].level)	/* nicht unterteilen, da beide Elemente auf gleichem Level */
{
   ...
   else CASE = compare(E[ind1].vertex,E[ind2].vertex,&s,&t);	/* gemeinsame Kante/Punkt? */
   ...
   switch (CASE)
   {  case 1:  IntKon1(c,&E[ind1],&E[ind2],&RW[g1],&Q[g1],&Q[g1],R,M,SingleLayer,DoubleLayer);
	       break;
      case 2:  IntKon2(c,&E[ind1],&Q[g1],R,M,SingleLayer,DoubleLayer,Identity);
	       break;
      case 3:  IntKon3(c,&E[ind1],&E[ind2],s,t,&Q[g1],R,M,SingleLayer,DoubleLayer);
	       break;
      case 4:  IntKon4(c,&E[ind1],&E[ind2],s,t,&Q[g1],R,M,SingleLayer,DoubleLayer);
               break;
      default: c[0] = c[1] = c[2] = 0;  printf("ERROR: CASE != 1,2,3,4 \n");
      }
   }
