...
int main(){
  ...
  dalton_wem_get_potential_coordinates_(xpotential_coordinates, ypotential_coordinates,
					zpotential_coordinates);
  ...
  */
  ...
  dalton_wem_get_charges_(&num_points, &num_charges, potential_values, charges, 
			  xcharge_positions, ycharge_positions, zcharge_positions);
  ...
  energy1=-0.5*energy1; // factor from Helmut
