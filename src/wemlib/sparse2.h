...
void init_sparse2(sparse2 *A, unsigned int m, unsigned int n, unsigned int n_max);
 ...
 *======================================*/
void init_pattern(sparse2 *A, unsigned int m, unsigned int n, unsigned int n_max);
 /* fuer jede Zeile werden n_max Elemente belegt */
