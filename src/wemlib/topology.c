...
{  
   ...
   {  for (i3=1; i3<n; i3++) (*F)[fz-1+i3][1] = (*F)[fz+i3][0] = K[i2][n-i3];
      }
   ...
   {  for (i3=1; i3<n; i3++) (*F)[fz+i3*n-1][2] = (*F)[fz+(i3+1)*n-1][1] = K[i2][n-i3];
      }
   ...
   {  for (i3=1; i3<n; i3++) (*F)[fz+n*n-i3][3] = (*F)[fz+n*n-i3-1][2] = K[i2][n-i3];
      }
   ...
   {  for (i3=1; i3<n; i3++) (*F)[fz+n*(n-i3-1)][3] = (*F)[fz+n*(n-i3)][0] = K[i2][n-i3];
      }
