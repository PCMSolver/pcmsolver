...
unsigned int compare(unsigned int *F1, unsigned int *F2, 
...
void quadrature_grade_smooth(signed int *g1, signed int *g2,
...
void quadrature_grade_nonsmooth(signed int *g1, signed int *g2,
	unsigned int m1, unsigned int m2, double dist, double prec);
/* bestimmt fuer Elemente der Level m1 und m2 
   mit dem Abstand dist die benoetigten Quadraturgrade
