...
/*! \class CPCMSolver
 *  \test \b NH3GePolRestart tests CPCMSolver using ammonia with a GePol cavity read
 * from .npz file
 */
TEST_CASE("Test solver for the C-PCM for NH3 and a restarted GePol cavity",
          "[solver][cpcm][cpcm_gepol-NH3_from-file]") {
  // Set up cavity
