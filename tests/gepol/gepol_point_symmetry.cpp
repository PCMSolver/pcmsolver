...
SCENARIO("GePol cavity for a single sphere in different Abelian point groups", "[gepol][gepol_point_symmetry]")
{
    ...
    GIVEN("A single sphere")
    {
        ...
        WHEN("the point group is C2")
        {
            ...
            /*! \class GePolCavity
             *  \test \b GePolCavityC1Test_irreducible_size tests GePol cavity irreducible size for a point charge in C2 symmetry with added spheres
             */
            AND_THEN("the irreducible size of the cavity is")
            {
                int size = 16;
            ...
            /*! \class GePolCavity
             *  \test \b GePolCavityC1Test_area tests GePol cavity surface area for a point charge in C2 symmetry with added spheres
             */
            AND_THEN("the surface area of the cavity is")
            {
                double area = 4.0 * M_PI * pow(1.0, 2);
            ...
            /*! \class GePolCavity
             *  \test \b GePolCavityC1Test_volume tests GePol cavity volume for a point charge in C2 symmetry with added spheres
             */
            AND_THEN("the volume of the cavity is")
            {
                double volume = 4.0 * M_PI * pow(1.0, 3) / 3.0;
    ...
    GIVEN("A single sphere")
    {
        ...
        WHEN("the point group is Cs")
        {
            ...
            /*! \class GePolCavity
             *  \test \b GePolCavityCsTest_irreducible_size tests GePol cavity irreducible size for a point charge in Cs symmetry with added spheres
             */
            AND_THEN("the irreducible size of the cavity is")
            {
                int size = 16;
            ...
            /*! \class GePolCavity
             *  \test \b GePolCavityCsTest_area tests GePol cavity surface area for a point charge in Cs symmetry with added spheres
             */
            AND_THEN("the surface area of the cavity is")
            {
                double area = 4.0 * M_PI * pow(1.0, 2);
            ...
            /*! \class GePolCavity
             *  \test \b GePolCavityCsTest_volume tests GePol cavity volume for a point charge in Cs symmetry with added spheres
             */
            AND_THEN("the volume of the cavity is")
            {
                double volume = 4.0 * M_PI * pow(1.0, 3) / 3.0;
    ...
    GIVEN("A single sphere")
    {
        ...
        WHEN("the point group is Ci")
        {
            ...
            /*! \class GePolCavity
             *  \test \b GePolCavityCiTest_irreducible_size tests GePol cavity irreducible size for a point charge in Ci symmetry with added spheres
             */
            AND_THEN("the irreducible size of the cavity is")
            {
                int size = 16;
            ...
            /*! \class GePolCavity
             *  \test \b GePolCavityCiTest_area tests GePol cavity surface area for a point charge in Ci symmetry with added spheres
             */
            AND_THEN("the surface area of the cavity is")
            {
                double area = 4.0 * M_PI * pow(1.0, 2);
            ...
            /*! \class GePolCavity
             *  \test \b GePolCavityCiTest_volume tests GePol cavity volume for a point charge in Ci symmetry with added spheres
             */
            AND_THEN("the volume of the cavity is")
            {
                double volume = 4.0 * M_PI * pow(1.0, 3) / 3.0;
    ...
    GIVEN("A single sphere")
    {
        ...
        WHEN("the point group is D2")
        {
            ...
            /*! \class GePolCavity
             *  \test \b GePolCavityD2Test_irreducible_size tests GePol cavity irreducible size for a point charge in D2 symmetry with added spheres
             */
            AND_THEN("the irreducible size of the cavity is")
            {
                int size = 8;
            ...
            /*! \class GePolCavity
             *  \test \b GePolCavityD2Test_area tests GePol cavity surface area for a point charge in D2 symmetry with added spheres
             */
            AND_THEN("the surface area of the cavity is")
            {
                double area = 4.0 * M_PI * pow(1.0, 2);
            ...
            /*! \class GePolCavity
             *  \test \b GePolCavityD2Test_volume tests GePol cavity volume for a point charge in D2 symmetry with added spheres
             */
            AND_THEN("the volume of the cavity is")
            {
                double volume = 4.0 * M_PI * pow(1.0, 3) / 3.0;
    ...
    GIVEN("A single sphere")
    {
        ...
        WHEN("the point group is C2v")
        {
            ...
            /*! \class GePolCavity
             *  \test \b GePolCavityC2vTest_irreducible_size tests GePol cavity irreducible size for a point charge in C2v symmetry with added spheres
             */
            AND_THEN("the irreducible size of the cavity is")
            {
                int size = 8;
            ...
            /*! \class GePolCavity
             *  \test \b GePolCavityC2vTest_area tests GePol cavity surface area for a point charge in C2v symmetry with added spheres
             */
            AND_THEN("the surface area of the cavity is")
            {
                double area = 4.0 * M_PI * pow(1.0, 2);
            ...
            /*! \class GePolCavity
             *  \test \b GePolCavityC2vTest_volume tests GePol cavity volume for a point charge in C2v symmetry with added spheres
             */
            AND_THEN("the volume of the cavity is")
            {
                double volume = 4.0 * M_PI * pow(1.0, 3) / 3.0;
    ...
    GIVEN("A single sphere")
    {
        ...
        WHEN("the point group is C2h")
        {
            ...
            /*! \class GePolCavity
             *  \test \b GePolCavityC2hTest_irreducible_size tests GePol cavity irreducible size for a point charge in C2h symmetry with added spheres
             */
            AND_THEN("the irreducible size of the cavity is")
            {
                int size = 8;
            ...
            /*! \class GePolCavity
             *  \test \b GePolCavityC2hTest_area tests GePol cavity surface area for a point charge in C2h symmetry with added spheres
             */
            AND_THEN("the surface area of the cavity is")
            {
                double area = 4.0 * M_PI * pow(1.0, 2);
            ...
            /*! \class GePolCavity
             *  \test \b GePolCavityC2hTest_volume tests GePol cavity volume for a point charge in C2h symmetry with added spheres
             */
            AND_THEN("the volume of the cavity is")
            {
                double volume = 4.0 * M_PI * pow(1.0, 3) / 3.0;
    ...
    GIVEN("A single sphere")
    {
        ...
        WHEN("the point group is D2h")
        {
            ...
            /*! \class GePolCavity
             *  \test \b GePolCavityD2hTest_irreducible_size tests GePol cavity irreducible size for a point charge in D2h symmetry with added spheres
             */
            AND_THEN("the irreducible size of the cavity is")
            {
                int size = 4;
            ...
            /*! \class GePolCavity
             *  \test \b GePolCavityD2hTest_area tests GePol cavity surface area for a point charge in D2h symmetry with added spheres
             */
            AND_THEN("the surface area of the cavity is")
            {
                double area = 4.0 * M_PI * pow(1.0, 2);
            ...
            /*! \class GePolCavity
             *  \test \b GePolCavityD2hTest_volume tests GePol cavity volume for a point charge in D2h symmetry with added spheres
             */
            AND_THEN("the volume of the cavity is")
            {
                double volume = 4.0 * M_PI * pow(1.0, 3) / 3.0;
